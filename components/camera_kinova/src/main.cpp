...
class camera_kinova : public RoboComp::Application
{
public:
	camera_kinova (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::camera_kinova::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::camera_kinova app(prefix, startup_check_flag);
