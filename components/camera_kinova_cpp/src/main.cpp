...
/** \mainpage RoboComp::camera_kinova_cpp
 *
 * \section intro_sec Introduction
 *
 * The camera_kinova_cpp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/camera_kinova_cpp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class camera_kinova_cpp : public RoboComp::Application
{
public:
	camera_kinova_cpp (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::camera_kinova_cpp::initialize()
{
...
int ::camera_kinova_cpp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::camera_kinova_cpp app(prefix, startup_check_flag);
