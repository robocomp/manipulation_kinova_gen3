...
_SAFETYIDENTIFIERBANKA = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BRAKE_DRIVE_FAULT', index=28, number=134217728,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BRAKE_RELEASE_MOTION_OUT_OF_RANGE', index=29, number=268435456,
      options=None,
      type=None),
  ],
  containing_type=None,
