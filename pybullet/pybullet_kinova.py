...
robot_id = p.loadURDF("/home/robocomp/robocomp/components/manipulation__kinova_gen3/pybullet/gen3_robotiq_2f_140.urdf", basePosition=[0, 0, 0], baseOrientation=p.getQuaternionFromEuler([0, 0, 0]), flags=flags)
