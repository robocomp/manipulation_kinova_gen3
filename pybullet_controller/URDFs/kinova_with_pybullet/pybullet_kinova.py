...
robot_id = p.loadURDF("/home/alfith/Escritorio/kinova_with_pybullet/gen3_robotiq_2f_85.urdf", basePosition=[0, 0, 0], baseOrientation=p.getQuaternionFromEuler([0, 0, 0]), flags=flags)
